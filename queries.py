...
queries = [
    "CREATE TABLE IF NOT EXIST Student(id INTEGER PRIMARY KEY AUTOINCREMENT, firstname VARCHAR, last_name VARCHAR, Pesel INTEGER, Phone_number INTEGER, address VARCHAR)",
